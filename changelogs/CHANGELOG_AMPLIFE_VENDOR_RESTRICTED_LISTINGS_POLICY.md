# Amplife® Vendor Restricted Listings Policy Change Log

**About this log.** This change log identifies the material differences between each published version of the Amplife® Vendor Restricted Listings Policy and the version immediately preceding it. It is provided for transparency and reference convenience only; it does not modify, supplement, or interpret any version of the Restricted Listings Policy. The version of the Restricted Listings Policy in effect at the time a listing was created or maintained governs that listing. If this summary conflicts with the text of any policy version, the policy text controls.
...
## Version dated June 28, 2024 (Initial publication of record)
