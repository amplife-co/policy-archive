# Amplife® Vendor Listing Guidelines Change Log

**About this log.** This change log identifies the material differences between each published version of the Amplife® Vendor Listing Guidelines and the version immediately preceding it. It is provided for transparency and reference convenience only; it does not modify, supplement, or interpret any version of the Listing Guidelines. The version of the Listing Guidelines in effect at the time a listing was created or maintained governs that listing. If this summary conflicts with the text of any policy version, the policy text controls.
...
## Version dated July 15, 2024 (Initial publication of record)
