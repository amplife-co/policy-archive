# Amplife® Return Policy Change Log

**About this log.** This change log identifies the material differences between each published version of the Amplife® Return Policy and the version immediately preceding it. It is provided for transparency and reference convenience only; it does not modify, supplement, or interpret any version of the Return Policy. The version of the Return Policy in effect on the date an order was placed governs that order. If this summary conflicts with the text of any policy version, the policy text controls.
...
## Version dated November 13, 2025
