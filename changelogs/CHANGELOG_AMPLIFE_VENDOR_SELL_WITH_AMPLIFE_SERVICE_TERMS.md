# Sell with Amplife® Service Terms Change Log

**About this log.** This change log identifies the material differences between each published version of the Sell with Amplife® Service Terms and the version immediately preceding it. It is provided for transparency and reference convenience only; it does not modify, supplement, or interpret any version of the Service Terms. The version of these Service Terms in effect at the time of your acceptance, as modified in accordance with their terms, governs the services provided under them. If this summary conflicts with the text of any Service Terms version, the Service Terms text controls.
