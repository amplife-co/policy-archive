# Amplife® Vendor Privacy Policy Change Log

**About this log.** This change log identifies the material differences between each published version of the Amplife® Vendor Privacy Policy and the version immediately preceding it. It is provided for transparency and reference convenience only; it does not modify, supplement, or interpret any version of the Vendor Privacy Policy. The version of the Vendor Privacy Policy in effect at the time information was collected governs that collection. If this summary conflicts with the text of any policy version, the policy text controls.
...
- **[MECHANICS] Maintenance only, no change in terms.** The company name is normalized to AMPLIFE LLC, the filed form of the entity name, and a document title is added at the head of the policy. No collection, use, sharing, retention, or rights statement is affected.

---

## Version dated July 16, 2026

*In effect July 16, 2026 to July 24, 2026*
