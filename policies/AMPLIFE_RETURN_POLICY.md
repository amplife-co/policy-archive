...
2.  In the "Email" field, enter your email address and click "Continue".  
      
3.  Open the email sent from our store and copy the six-digit verification code included in the email.  
      
4.  Return to the online store and enter the six-digit verification code.  
      
5.  Click "Request return" for the order you want to return.  
      
6.  If your order contains more than one item, select the specific items you want to return.  
      
7.  Select a return reason and add a note.  
...
3.  Store credit for the full purchase amount. Store credit issued as a remedy never expires.  
...
Once we receive and inspect your returned item, we aim to notify you within 3 business days of whether your refund has been approved. If approved, we aim to issue your refund to your original payment method within 10 business days of approval. Processing times vary by bank or payment provider and are outside our control.
...
## **European Union and United Kingdom: 14-Day Right of Withdrawal**
...
For all return, exchange, or refund questions, contact us at hello@amplife.co. Prior versions are available in[ our version history](https://www.amplife.co/pages/amplife-policy-archive).
