...
We use Vendor contact information to send program communications, which are part of operating the Vendor Program. Where we send marketing communications about additional Amplife® services, you may opt out at any time using the unsubscribe mechanism or by emailing hello@amplife.co; program and transactional communications will continue, because the program cannot operate without them.

# Cookie Policy

Vendor-facing portals and dashboards use cookies necessary for login, security, and session management. Cookies on our general websites are described in the [Amplife® Privacy Policy](https://www.amplife.co/policies/privacy-policy).
...
When we make material changes to this policy, we will notify Vendors as described in the modification provisions of the Vendor Participation Agreement. Prior versions are available in [our version history](https://www.amplife.co/pages/amplife-policy-archive).

# Contact and Complaints

Amplife® takes your privacy questions seriously. Contact us at hello@amplife.co. Our team reviews your inquiry to determine how best to respond, and in most cases all substantive contacts receive a response within seven days. We may require additional information or let you know that we need more time. Where your complaint shows an improvement we should make, we will make it at the next reasonable opportunity, and if a privacy issue has negatively affected you or another person, we will take steps to address it. You may at any time, including if you are not satisfied with our response, refer your complaint to the applicable regulatory authority.
