...
Under the [Sell with Amplife® Service Terms](https://help.amplife.co/en-US/sell-with-amplife-service-terms-524172#1-your-listings-and-orders), you must provide accurate and complete Required Listing Information for each of your listings, and promptly update that information as necessary so it always remains accurate and complete:

Some items below are product-specific. For services and events, provide the details that fit your listing, such as scheduling, duration, location, and cancellation policies in the description, and skip product-only items like materials, physical specifications, and shipping details. 

  - A digitized image that accurately depicts only your listing, complies with these Listing Guidelines, and does not include any additional logos, text, or other markings.
  - Title.
  - Brand.
  - Purchase Price.
  - Listing Type (Disabled-Owned, Disabled-Designed, or Disabled-Solution).
  - Disability Helped within the category and browse structure.
  - Categorization within each Amplife® Listing category and browse structure.
  ...
  - Information regarding in-stock status and availability, shipping limitations or requirements, and the estimated or promised shipment and delivery date and shipping charge.
  - Any text, disclaimers, warnings, notices, labels, warranties, or other content required by applicable law to be displayed, or that is necessary for the safe use of your listing.
  - Any other information reasonably requested by us, such as invoices and other documentation demonstrating the safety and authenticity of your listings.

### California Proposition 65 warnings

If your listing requires a warning under California Health and Safety Code Section 25249.6 (a "Proposition 65 Warning"), you must provide the warning in the manner specified in the Program Policies. Our display of a Proposition 65 Warning on a listing detail page is confirmation that we received it. If we determine that a listing requires a Proposition 65 Warning that has not been provided, the listing will be suspended immediately, and it will be reinstated once we receive and display the required warning.
...
All details of a listing, such as [Media](https://help.amplife.co/en-US/listing-guidelines-539771#media), [Title](https://help.amplife.co/en-US/listing-guidelines-539771#title), and [Description](https://help.amplife.co/en-US/listing-guidelines-539771#description), and any details of a [page or collection page](https://help.amplife.co/en-US/create-your-brand-experience-526435) are the Content. Requirements apply to all listings and brand experiences on Amplife®:

### Content requirements

  - You cannot add Content that infringes upon the Intellectual Property (IP) rights of other vendors, parties or individuals. For more information, check out the [Intellectual Property Policy](https://help.amplife.co/en-US/intellectual-property-policy-524232).
  ...
  - You must not use an AI-generated depiction of any real, identifiable person in your Content without that person's consent. Amplife® may remove any such content in its discretion.
  - None of the following are allowed:
      
      - Pornographic, obscene, or offensive material.
      - Phone numbers, addresses, email addresses, or website URLs, unless you are on an active [Showcase Selling Plan](https://help.amplife.co/en-US/cost-to-sell-583488#showcase-selling-plan).
  - None of the following are allowed in listing detail page titles, Descriptions, Overview Descriptions, Specifications, or Media:
      ...
      - Time-sensitive information, such as dates of tours, seminars, or lectures, unless the listing is an [event](https://help.amplife.co/en-US/listing-guidelines-539771#taxonomy).
...
Good Title quality is a key factor in ensuring a positive customer experience on Amplife®:
  ...
  - Size and color variations should be included in Titles for listing [Variations](https://help.amplife.co/en-US/listing-guidelines-539771#variations), not the main Title.

### Title FAQ

1.  What if my brand name contains a prohibited character, such as \!, ©, ™, or ®?  
    These characters may appear in your brand’s name which is placed in the byline that appears on every listing detail page and in search results, and they may appear in the Description & Overview Description.
2.  Does Amplife® automatically put a brand name at the start of my Title, or do I need to do that myself?  
    Yes, we recommend that you begin a Title with the listing’s brand name or sub-brand name. Amplife® does not automatically put a brand name at the start of your Title.
3.  What if my listing doesn’t have a brand name?  
    Your vendor name will be your brand name.
4.  How do I know if my listings have been rejected?  
    Go to the Vendor Dashboard within the Vendor Portal and click the Pending & Rejected Listings page to check your rejected listings
...
1.  The parent listing: The listing displayed in the search results
2.  The child listings: The listings that are related to each parent listing
...
### Media requirements
  ...
  - Must not include an AI-generated depiction of any real, identifiable person without that person's consent. Amplife® may remove any such Media in its discretion.
...
The Amplife® website sets the First Image and variant Media displayed on collection pages to a ratio of 4:5, except for the listing detail page which is displayed with a natural ratio (if your Media is landscape, it will be cropped to a 4:5 ratio on all pages except for the listing detail page where it will display in the natural landscape ratio).
  ...
  - Upload your First Image with the listing fitting just below the top and bottom edges of a 1:1 ratio with white above and below to have a 4:5 ratio. Your First Image will fully display without being cropped on other areas of Amplife®.
...
The amount of money required to complete the purchase of a listing is the Price. The discounted Price from the original Price is the Compare Price. Requirements apply to all listings on Amplife®. All pricing must adhere to the [Fair Pricing Policy](https://help.amplife.co/en-US/fair-pricing-policy-524245):

### Price requirements (Fair Pricing Policy)

Vendors are responsible for setting the Purchase Prices of their Listings on Amplife®.

We may review the Purchase Prices of Listings on Amplife®, including shipping charges, and compare them with other prices available to our customers. If we identify pricing practices on a Listing that harm customer trust, we can remove the Listing and, in serious or repeated cases, suspend and/or terminate your Amplife® account, as provided in Sections 15(c) and 3 of the [Amplife® Vendor Participation Agreement](https://help.amplife.co/en-US/amplife-vendor-participation-agreement-537645) ("Agreement").
...
Pricing practices that harm customer trust include, but are not limited to:
  ...
  - Setting a Purchase Price on a Listing that is significantly higher than recent prices for that Listing on Amplife®;
  - Selling multiple units of a Listing for more per unit than that of a single unit of the same Listing; and
  - Setting an excessive shipping fee. Amplife® considers current public carrier rates, reasonable handling charges, as well as buyer perception when determining whether a shipping charge violates our Fair Pricing Policy.
...
### Listing Type requirements
  ...
  - Must be Disabled-Owned, Disabled-Designed, or Disabled-Solution.
...
### Listing Type certification
  ...
  - For Listings sold under an authorized distribution arrangement, Listing Type designations describe the brand named on the Listing (the manufacturer), not the fulfilling distributor. For more information, check out the [Sell with Amplife® Service Terms](https://help.amplife.co/en-US/sell-with-amplife-service-terms-524172#1-your-listings-and-orders).
  ...
  - Disability means the umbrella term for impairments, activity limitations and participation restrictions, where functioning and disability are a dynamic interaction between health conditions and contextual factors, both personal and environmental, and is not an attribute of the person. Disability results from the interaction between persons with impairments and attitudinal and environmental barriers that hinder their full and effective participation in society on an equal basis with others. World Report on Disability - World Health Organization. [Link](https://iris.who.int/handle/10665/44575)
      ...
      - Functioning and disability are multi-dimensional concepts, relating to:
          ...
          - the environmental factors which affect these experiences (and whether these factors are facilitators or barriers).
              ...
              - The ICF: An Overview - Centers for Disease Control and Prevention (CDC). [Link](https://www.cdc.gov/nchs/data/icd/icfoverview_finalforwho10sept.pdf)
...
Specifications apply to physical products only. Service and event listings do not have a Specifications section, so these requirements do not apply to them. 

Requirements apply to all product listings on Amplife®:

### Specification requirements

  - At least one Specification relevant to your listing is required, for example, Material: 100% Cotton. Beyond that minimum, completing the remaining Specifications is optional but strongly encouraged: if this information is missing or incorrect, customers will have a difficult time finding, comparing, and purchasing your listings. Specifications are also used in our search and filtering options to help customers find listings with specific details. By not adding Specifications, customers will be more inclined to purchase a competitor's listing with complete details that help them complete their purchase.
  ...
  - Must not add details for Specifications that are irrelevant to the listing.
...
You are required to display the applicable disclosure or statement if your listing applies to the following:
  ...
  - California Air Resources Board
      ...
      - Listings for products that are subject to California air pollution regulations, such as engines, aftermarket auto parts, and consumer products, must include the applicable Executive Order number or certification permitting sale into California. For more information, check out the [California Air Resources Board](http://www.arb.ca.gov/homepage.htm).
  - California Prop 65
      
      - Listings must comply with [California's Proposition 65](http://www.oehha.ca.gov/prop65/background/p65plain.html), which requires notice to California customers of products that contain chemicals on [California's list of chemicals known to the state to cause cancer or reproductive toxicity](http://oehha.ca.gov/prop65/prop65_list/files/p65single090211.pdf). Listings for products containing chemicals on California's list must contain the applicable notice. If we determine that a listing requires a Proposition 65 warning that has not been provided, the listing will be suspended immediately and reinstated once we receive and display the required warning. For more information, check out the [California Office of Environmental Health Hazard Assessment Proposition 65](http://www.oehha.ca.gov/prop65/background/p65plain.html).
  ...
  - Textile Product Descriptions
      ...
      - Listings for textile products (for example, bedding and clothing) must comply with the [Textile Products Identification Act](https://www.ftc.gov/enforcement/rules/rulemaking-regulatory-reform-proceedings/textile-products-identification-act-text) (the "Textile Act"), which requires the following disclosures, among others:
...
The method of how a listing is delivered and the applicable return policy is the Shipping & Returns. All listings where the transaction completes on Amplife® ([Standard Listings](https://help.amplife.co/en-US/create-listings-553287#standard-listing)) are subject to the [Amplife® Refund Policy](https://www.amplife.co/policies/refund-policy). If you would like to include an extended return window in addition to the [Amplife® Refund Policy](https://www.amplife.co/policies/refund-policy) or a warranty, you can add it by contacting us at hello@amplife.co. If you would like to use your refund policy which has a shorter return window than ours, you can have that listing's transaction completed off Amplife® ([Showcase Listing](https://help.amplife.co/en-US/create-listings-553287#showcase-listing)) to fulfill the order through your chosen sales channel.

All Standard Listings must choose their shipping method, if it can be delivered, and a return policy that adheres to the [Sell with Amplife® Service Terms](https://help.amplife.co/en-US/sell-with-amplife-service-terms-524172#2-sale-and-fulfillment-refunds-and-returns):
...
(g) identify yourself as the Vendor of each of Your Listings on all packing slips or other information included or provided in connection with Your Listings and as the Vendor to which a customer may return the applicable Listing;
...
The [Amplife® Refund Policy](https://www.amplife.co/policies/refund-policy) will apply to Standard Listings. The [Amplife® Refund Policy](https://www.amplife.co/policies/refund-policy) may be updated from time to time, and the version in effect at the time of each transaction governs that transaction. You will promptly accept, calculate, and process cancellations, returns, refunds, and adjustments in accordance with the Agreement and the [Amplife® Refund Policy](https://www.amplife.co/policies/refund-policy), using the functionality we enable for your account. Without limiting your obligations, we may in our sole discretion accept, calculate, and process cancellations, returns, refunds, and adjustments for the benefit of customers.
